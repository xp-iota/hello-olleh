...
- OpenCode: [17-settings-config.md](../hello-opencode/17-settings-config.md), [32-worktree-sandbox.md](../hello-opencode/07-error-security.md), [10-session-resume.md](../hello-opencode/10-session-resume.md)
