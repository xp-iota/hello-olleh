...
> 横向对齐规则：`01-25` 是五个 AI Coding CLI 目录共享的主题主干；Codex 特有的 `26-ghost-snapshot.md` 作为附录保留。跨项目比较统一维护在 [`../hello-harness/15-topic-alignment-matrix.md`](../hello-harness/15-topic-alignment-matrix.md)。
