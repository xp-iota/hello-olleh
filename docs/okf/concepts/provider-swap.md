...
| 整条工具调用回路 | 本地 SSE 桩 + 真实 agent-loop | 已验证，见 [一次工具调用等于两步](tool-call-round-trip.md) |
...
- [一次工具调用等于两步](tool-call-round-trip.md)
- 长文分析：[07 请求管线：LLM、工具与提示](../../hello-dsh/07-请求管线-LLM工具与提示.md)
